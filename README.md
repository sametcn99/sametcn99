...
Stay updated with my latest blog posts, tutorials, and other content published on my personal website. Here you'll find thoughts on technology, development guides, and project showcases.
...
- **Starred [NodeDaemon/NodeDaemon](https://github.com/NodeDaemon/NodeDaemon)** _(Jan 11, 2026)_
- **Labeled issue [#7](https://github.com/sametcn99/env-protector/issues/7) in [sametcn99/env-protector](https://github.com/sametcn99/env-protector)** _(Jan 10, 2026)_
- **Assigned issue [#7](https://github.com/sametcn99/env-protector/issues/7) in [sametcn99/env-protector](https://github.com/sametcn99/env-protector)** _(Jan 10, 2026)_
...
A quantitative look at my GitHub presence, summarizing my overall contributions and repository metrics. These stats reflect my coding habits, preferred languages, and long-term activity.

### GitHub Stats

Detailed numbers breaking down my repositories, commits, pull requests, and other key interactions. This table provides a quick snapshot of my impact and engagement on the platform.
...
- [**env-protector**](https://sametcc.me/repo/env-protector) ★15 - TypeScript<br />_Created: Sep 14, 2024 • Updated: Jan 12, 2026_<br />Protect your secrets from being exposed
...
- [**redux-practice**](https://sametcc.me/repo/redux-practice) ★2 - TypeScript<br />_Created: Dec 6, 2023 • Updated: Dec 18, 2024_<br />This project is an example application created to learn the Redux library.
...
A behind-the-scenes look at how this profile README is automatically generated and updated. View details about the GitHub Actions workflow, run times, and the tools powering this automation.

This file was automatically generated by [GitHub Actions](https://github.com/sametcn99/sametcn99/actions/runs/21437593277) using [Bun](https://bun.sh) & [TypeScript](https://www.typescriptlang.org/).

- **Workflow Name:** Update Profile README
- **Run Number:** 37
- **Run ID:** [21437593277](https://github.com/sametcn99/sametcn99/actions/runs/21437593277)
- **Trigger Event:** schedule
- **Run Started:** Wed, 28 Jan 2026 12:07:53 GMT

---

Last updated: Wed, 28 Jan 2026 12:08:05 GMT
