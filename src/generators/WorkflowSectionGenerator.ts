...
export class WorkflowSectionGenerator implements ISectionGenerator {
	...
	generate(): string {
		...
		content += `A behind-the-scenes look at how this profile README is automatically generated and updated. View details about the GitHub Actions workflow, run times, and the tools powering this automation.${MarkdownUtils.newLine()}${MarkdownUtils.newLine()}`;
